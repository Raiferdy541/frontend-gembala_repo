...
export default {
  ...
  computed: {
    ...
    ...mapState(d$lepasSapih, ["g$lepasSapih", "g$byPopulasi", "g$kandang"]),
  },

  async mounted() {
    try {
      await this.a$listLepasSapih();
    } catch (error) {
  ...
  methods: {
    ...mapActions(d$lepasSapih, ["a$listLepasSapih"]),
  },
};
</script>
...
<template>
  <main-layout :title="pageTitle" is-full style="background: transparent">
    <template #header>
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="row">
            ...
            <span class="text-center m-2">
              <router-link to="lepas-sapih/data-lepas-sapih">
                <base-button
            ...
            <span class="text-center m-2">
              <router-link to="lepas-sapih/langkah-kerja">
                <base-button
                  v-if="userInfo.role !== 'bod'"
                  type="secondary"
                  class="btn-lg text-dark"
      ...
      <div class="row" v-if="g$lepasSapih.length">
        <div class="col-sm-4">
          <card-comp>
      ...
      <div class="row ml-1" v-if="g$lepasSapih.length">
